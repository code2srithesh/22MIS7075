package com.assignment.logging_middleware;
...
public class LogClient {
    ...
    public void log(String stack, String level, String pkg, String message) {
        try {
            ...
            if (stack.equals("backend") && !BACKEND_PACKAGES.contains(pkg)) return;
            if (stack.equals("frontend") && !FRONTEND_PACKAGES.contains(pkg)) return;
